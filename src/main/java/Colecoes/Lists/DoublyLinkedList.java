...
public class DoublyLinkedList<T> implements ListADT<T>, Iterable<T> {
    ...
    public abstract class BasicIterator<E> implements Iterator<T> {
         ...
         * @throws ConcurrentModificationException if the list was modified while
         *                                         iterating
        ...
        /**
         * Removes from the underlying doubly linked list the last element returned by
         * the {@code next} method.
         *
         * @throws ConcurrentModificationException if the list was modified while
         *                                         iterating
         * @throws NoSuchElementException          if the last element was not returned
         *                                         by {@code next} or if the list is
         *                                         empty
         */
        @Override
        public void remove() {
