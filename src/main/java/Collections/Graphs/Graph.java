...
/**
 * Class that represents a graph implementation using an adjacency matrix.
 * @param <T> The generic type of the graph.
 */
...
public class Graph<T> implements GraphADT<T> {
    ...
    /**
     * Metod that adds a new vertex to the graph. If the current number of vertices equals the array length, the capacity is expanded before adding the new vertex.
     */
